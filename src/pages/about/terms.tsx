...
import { Box, Card, Grid, Paper, CardHeader, CardContent, Typography, Divider } from "@mui/material"
...
const Terms = () => {
  ...
  return (
    <>
    <div>
    <PageHeading  title={'Terms'}>

    </PageHeading>
    </div>
      <Box sx={{ m: 11.5 }} >
        <>
        <PageBodyContent title={'Terms'}>
          Terms about your usage
            <p>
